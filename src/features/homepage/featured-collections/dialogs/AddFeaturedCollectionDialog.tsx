...
import { useAddFeaturedCollection } from "../hooks/useAddFeaturedCollection";
...
export default function AddFeaturedCollectionDialog({
  open,
  onOpenChange,
}: Props) {
  const collections = useCollections();
  const featuredCollections = useFeaturedCollections();
  const addMutation = useAddFeaturedCollection();
