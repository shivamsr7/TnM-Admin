...
export default function InstagramReviewDialog({
  ...
  const createReview = useCreateInstagramCustomerReview();
  ...
  useEffect(() => {
    ...
    setFile(null);
    setPreviewUrl(review?.screenshot_url ?? null);
  }, [open, review, form]);
  ...
  async function onSubmit(values: FormValues) {
    try {
      ...
      let screenshotUrl = review?.screenshot_url ?? "";
      let screenshotPath = review?.screenshot_path ?? "";
      ...
      if (!screenshotUrl || !screenshotPath) {
        throw new Error("Please upload the Instagram DM screenshot.");
      }
      ...
      if (review) {
        ...
        toast.success("Instagram review updated.");
      } else {
        await createReview.mutateAsync(payload);
        toast.success("Instagram review added.");
      }
  ...
  const saving =
    uploading || createReview.isPending || updateReview.isPending;
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[92vh] overflow-y-auto sm:max-w-2xl">
        <DialogHeader>
          <DialogTitle>
            {isEditing ? "Edit Instagram Review" : "Add Instagram Review"}
          </DialogTitle>
        </DialogHeader>
        ...
        >
          <div className="space-y-2">
            <Label>Instagram DM Screenshot *</Label>
            ...
            <label className="block cursor-pointer">
              ...
              {previewUrl ? (
                ...
                <div className="flex min-h-44 flex-col items-center justify-center rounded-xl border-2 border-dashed border-neutral-200 bg-neutral-50 text-neutral-500">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="review_text"
              rows={4}
              placeholder="Optional clean text version of the Instagram review..."
          ...
          <div className="grid gap-5 sm:grid-cols-3">
            ...
            <div className="space-y-2">
              <Label htmlFor="display_order">Story Order</Label>
              <Input
                id="display_order"
                type="number"
                min={0}
