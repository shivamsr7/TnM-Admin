...
export default function BannerForm({
  ...
  const form =
    useForm<BannerFormData>({
      ...
      defaultValues: {
        ...
        position:
          "Homepage Hero" as BannerPosition,
        ...
        /*
         * Existing banners continue
         * to show their overlay content.
         */
  ...
  useEffect(() => {
    ...
    form.reset({
      ...
      /*
       * Fallback is important for
       * banners created before this
       * field existed.
       */
            ...
            >
              ...
              <div>
                ...
                <p
                  ...
                  "
                >
                  Show the title, subtitle and
                  button over the banner image.
                </p>
